...
#DEBUG_DEFINES += -DCAL_DEBUG=1
#DEBUG_DEFINES += -DHOSTAPD_INTF_DEBUG=1
#DEBUG_DEFINES += -DPOWER_SAVE_DEBUG=1
#DEBUG_DEFINES += -DDRIVER_BEKEN_DEBUG=1
#DEBUG_DEFINES += -DETHERNETIF_DEBUG=1
#DEBUG_DEFINES += -DSTART_TYPE_DEBUG=1
#DEBUG_DEFINES += -DHEAP_4_DEBUG=1
#DEBUG_DEFINES += -DFLASH_DEBUG=1
#DEBUG_DEFINES += -DSYSCTRL_DEBUG=1
#DEBUG_DEFINES += -DFCLK_DEBUG=1
#DEBUG_DEFINES += -DFUNC_DEBUG=1
#DEBUG_DEFINES += -DCALN_DEBUG=1	
...
INCLUDES += -I$(BEKEN_DIR)/beken378/app/http
